...
async function onCambiarClave() {
  ...
  try {
    ...
    const response = await axios.patch(
      `${import.meta.env.VITE_BASE_URL_ENDPOINT}/usuarios/${usuarioId}/cambiar-clave`,
      {
    ...
    <div class="login-card">
      ...
      <form @submit.prevent="onCambiarClave" class="login-form" novalidate>
        ...
        <div class="field-group">
          ...
          <div class="input-wrap">
            ...
            <input
              ...
              required
            />
            <button type="button" class="toggle-pass" @click="mostrarClaves = !mostrarClaves">
        ...
        <div class="field-group">
          ...
          <small
            v-if="confirmarClave && contrasenasCoinciden && largoValido"
            class="validar-texto exito"
          >
