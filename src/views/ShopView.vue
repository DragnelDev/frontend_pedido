  ...
  <section class="shop-page">
    ...
    <div class="shop-container">
      ...
      <div v-if="categorias.length" class="categorias-strip">
        <button class="cat-chip" :class="{ activo: !categoriaActiva }" @click="limpiarCategoria">
          Todos
      ...
      <div class="resultados-bar">
        <span class="resultados-count">
          ...
          <template v-if="categoriaActiva">
            en <strong>{{ categoriaActiva }}</strong></template
          >
          <template v-else-if="busqueda">
      ...
      <div v-else class="vacio">
        ...
        <p>
          ...
          <template v-else> Pronto tendremos nuevas delicias disponibles. </template>
        </p>
        <button
          v-if="categoriaActiva || busqueda"
          class="btn-reset"
...
.search-input:focus {
  border-color: #e91e8c;
  box-shadow:
    0 0 0 3px rgba(233, 30, 140, 0.09),
    0 2px 12px rgba(233, 30, 140, 0.07);
}
...
.cat-chip:not(.activo) .cat-count {
  background: #fce4ec;
  color: #e91e8c;
}
.cat-chip.activo .cat-count {
